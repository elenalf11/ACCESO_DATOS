...
public class Ejercicio3 {
	...
	public static void main(String[] args) {
		try {
			...
			// Inserciones tabla 3
			String sql_tabla3 = "INSERT INTO LIBROS (ISBN, NOMBRE, AUTOR, PAGINAS) VALUES ('001', 'El Quijote', 'Miguel de Cervantes', 1000);";
			String sql_tabla_3_2 = "INSERT INTO LIBROS (ISBN, NOMBRE, AUTOR, PAGINAS) VALUES ('002', 'Harry Potter', 'J.K. Rowlin', 500);";
			String sql_tabla_3_3 = "INSERT INTO LIBROS (ISBN, NOMBRE, AUTOR, PAGINAS) VALUES ('003', 'La vuelta al mundo', 'Julio Verne', 700);";
			String sql_tabla_3_4 = "INSERT INTO LIBROS (ISBN, NOMBRE, AUTOR, PAGINAS) VALUES ('004', 'Invisible', 'Eloy Moreno', 400); ";
